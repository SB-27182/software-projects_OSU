...
public abstract class ProgramTest {
     ...
     */
    private static final String FILE_NAME_1 = "data/pTest3InstCall.bl";
    /**
     * The name of a file containing a BL program.
     */
    private static final String FILE_NAME_2 = "data/pTest3InstNoneCall.bl";
    /**
     * The name of a file containing a BL program.
     */
    private static final String FILE_NAME_3 = "data/pTestNoInst.bl";
    /**
     * The name of a file containing a BL program.
     */
    private static final String FILE_NAME_4 = "data/pTestNoInstMinBody.bl";
    /**
     * The name of a file containing a BL program.
     */
    private static final String FILE_NAME_5 = "data/program-sample.bl";
    ...
    public final void testName2() {
         ...
         */
        assertEquals(pRef, pTest);
        assertEquals("Instruction3NoneCalled", result);
    }
    ...
    public final void testName3() {
         ...
         */
        assertEquals(pRef, pTest);
        assertEquals("NoInstruction", result);
    }
    ...
    public final void testName4() {
         ...
         */
        assertEquals(pRef, pTest);
        assertEquals("NoInstructions-MinimumBody", result);
    }
     ...
     */
    @Test
    public final void testSwapContext_3Instructions() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_NAME_1);
    ...
    @Test
    public final void testSwapContext2_3Instructions() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_NAME_2);
    ...
    @Test
    public final void testSwapContext3_0Instruction() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_NAME_3);
    ...
    @Test
    public final void testSwapContext4_0Instruction() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_NAME_3);
