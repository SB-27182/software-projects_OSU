...
public abstract class StatementTest {
     ...
     * The name of a file containing a sequence of BL statements.
     */
    private static final String FILE_NAME_0c = "data/sTest_block_0Children.bl";
    /**
     * The name of a file containing a sequence of BL statements.
     */
    private static final String FILE_NAME_1c = "data/sTest_block_1Children.bl";
    /**
     * The name of a file containing a sequence of BL statements.
     */
    private static final String FILE_NAME_3c = "data/sTest_block_3Children.bl";
    ...
    /**
     * Test kind of statement.
     */
    @Test
    public final void testKindWhile() {//TODO
        /*
         * Setup
         */
    ...
    @Test
    public final void testKindCall() {//TODO
        /*
         * Setup
         */
        final int callPos = 0;
    ...
    @Test
    public final void testKindIf() {//TODO
        /*
         * Setup
         */
        final int ifPos = 1;
    ...
    @Test
    public final void testKindIfElse() {//TODO
        /*
         * Setup
         */
    ...
    /**
     * Test addToBlock at final position
     */
    @Test
    public final void testAddToBlock_EndOfSequence_seqLength3() {
        Statement sTest = this.createFromFileTest(FILE_NAME_3c);
        Statement sRef = this.createFromFileRef(FILE_NAME_3c);
        Statement emptyBlock = sRef.newInstance();

        Statement thiccRef = this.constructorRef().newInstance();
        Statement thiccTest = this.constructorTest().newInstance();
        String name = "test-statem";
        thiccRef.assembleCall(name);
        thiccTest.assembleCall(name);

        sRef.addToBlock(sRef.lengthOfBlock(), thiccRef);
        sTest.addToBlock(sTest.lengthOfBlock(), thiccTest);

        /*
         * Evaluation
         */
        assertEquals(emptyBlock, thiccTest);
        assertEquals(sRef, sTest);
    }

    @Test
    public final void testAddToBlock_EndOfSequence_seqLength1() {
        Statement sTest = this.createFromFileTest(FILE_NAME_1c);
        Statement sRef = this.createFromFileRef(FILE_NAME_1c);
        Statement emptyBlock = sRef.newInstance();
    ...
    @Test
    public final void testAddToBlock_EndOfSequence_seqLength0() {
        Statement sTest = this.createFromFileTest(FILE_NAME_0c);
        Statement sRef = this.createFromFileRef(FILE_NAME_0c);
        Statement emptyBlock = sRef.newInstance();
    ...
    /**
     * Test addToBlock at first position
     */
    @Test
    public final void testAddToBlock_FrontOfSequence_seqLength3() {
        Statement sTest = this.createFromFileTest(FILE_NAME_3c);
        Statement sRef = this.createFromFileRef(FILE_NAME_3c);
        Statement emptyBlock = sRef.newInstance();
        ...
        sRef.addToBlock(0, thiccRef);
        sTest.addToBlock(0, thiccTest);
    ...
    @Test
    public final void testAddToBlock_FrontOfSequence_seqLength1() {
        Statement sTest = this.createFromFileTest(FILE_NAME_1c);
        Statement sRef = this.createFromFileRef(FILE_NAME_1c);
        Statement emptyBlock = sRef.newInstance();
    ...
    @Test
    public final void testAddToBlock_FrontOfSequence_seqLength0() {
        Statement sTest = this.createFromFileTest(FILE_NAME_0c);
        Statement sRef = this.createFromFileRef(FILE_NAME_0c);
        Statement emptyBlock = sRef.newInstance();
     ...
     */
    @Test
    public final void testRemoveFromBlock_Interior_LeavingNonEmpty() {
        Statement sTest = this.createFromFileTest(FILE_NAME_3c);
        Statement sRef = this.createFromFileRef(FILE_NAME_3c);
        Statement nestedRef = sRef.removeFromBlock(1);
    ...
    @Test
    public final void testRemoveFromBlock_End_LeavingNonEmpty() {
        Statement sTest = this.createFromFileTest(FILE_NAME_3c);
        Statement sRef = this.createFromFileRef(FILE_NAME_3c);
    ...
    @Test
    public final void testRemoveFromBlock_Leaving_Empty() {
        Statement sTest = this.createFromFileTest(FILE_NAME_1c);
        Statement sRef = this.createFromFileRef(FILE_NAME_1c);
        Statement nestedRef = sRef.removeFromBlock(0);
     ...
     */
    @Test
    public final void testLengthOfBlock_length0() {//TODO
        Statement sTest = this.createFromFileTest(FILE_NAME_0c);
        Statement sRef = this.createFromFileRef(FILE_NAME_0c);
        int lengthRef = sRef.lengthOfBlock();
