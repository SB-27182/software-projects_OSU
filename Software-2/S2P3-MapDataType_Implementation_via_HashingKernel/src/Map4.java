...
public class Map4<K, V> extends MapSecondary<K, V> {
     ...
     * for all i:|$this.hashTable.entries| = hashTableSize integer
    ...
    public final void add(K key, V value) {
        ...
        int hashIndex = mod(key.hashCode(), this.hashTable.length());
        Map<K, V> openedMap = this.hashTable.entry(hashIndex);
        openedMap.add(key, value);
    ...
    public final Pair<K, V> remove(K key) {
        ...
        Pair<K, V> removed = this.hashTable.entry(index).remove(key);
    ...
    public final Pair<K, V> removeAny() {
        ...
        int i = 0;
        boolean indexHasStuff = false;

        while (i < this.hashTable.length() && !indexHasStuff) {
    ...
    public final V value(K key) {
        ...
        return this.hashTable.entry(hashIndex).value(key);
    }
    ...
    public final boolean hasKey(K key) {
        ...
        return this.hashTable.entry(hashIndex).hasKey(key);
    }
