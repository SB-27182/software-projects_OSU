...
public class List3<T> extends ListSecondary<T> {
    ...
    public final void addRightFront(T x) {
        ...
        this.rightLength = this.rightLength + 1;
        assert this.conventionHolds();
    }
    ...
    public final T removeRightFront() {
        ...
        Node left = this.lastLeft;
        Node extract = left.next;
        Node right = extract.next;

        T extractData = extract.data;
        left.next = right;
        right.previous = left;
    ...
    public final void advance() {
        ...
        Node oldLeft = this.lastLeft;
        this.lastLeft = oldLeft.next;
    ...
    public final void moveToFinish() {
        ...
        Node right = this.postFinish;
        this.lastLeft = right.previous;
    ...
    public final void retreat() {
        ...
        Node newRight = this.lastLeft;
        this.lastLeft = newRight.previous;
